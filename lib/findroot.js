...
function findroot(g,interval,initialpoint,options) {
  if(!g){return ;}
  if (typeof initialpoint ==='object') {options = initialpoint ; initialpoint = undefined; }
  options = options || {npoints_DNumeric : 10000, presicion : 0.001 , nstepsmax : 10000  } ;
...
module.exports = function (g,interval,initialpoint,options,cb) {
  if (cb && typeof cb === 'function') {
    setTimeout(function () {
      cb(findroot(g,interval,initialpoint,options));
    });
  } else {
